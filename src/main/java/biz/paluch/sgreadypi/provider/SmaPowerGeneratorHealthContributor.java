...
@Component
@Value
class SmaPowerGeneratorHealthContributor implements HealthIndicator {
    ...
    public Health health() {
     ...
     private void contribute(Health.Builder builder) {
        ...
        Map<String, Object> generator = Map.of("generator-power", powerGenerator.getGeneratorPower().toString(),
                "battery-soc", powerGenerator.getBatteryStateOfCharge().toString(),
                "inverters", inverters);
        ...
        builder.withDetail("generator", generator);
    }
}
